...
<?php endif; ?>
    ...
    <tr><td><?php echo e($v->sku); ?></td><td><?php echo e($v->title); ?></td><td><?php echo e($v->price); ?></td><td><?php echo e($v->qty); ?></td><td><?php echo e(($v->price)*($v->qty)); ?></td><td><!-- Single button -->
<div class="btn-group">
  ...
  <ul class="dropdown-menu">
    ...
    <span style="float: right;width:100px;height:30px;line-height:30px" class="label label-success">total:<?php echo e($order->total); ?><input class="form-control" type="hidden" name="product_total"/></span>
