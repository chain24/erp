				...
				<ul class="nav navbar-nav ">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu" role="category">
							<li>{{ link_to_route('category.index','List') }}</li>
							<li>{{ link_to_route('category.create','Add Category') }}</li>
						</ul></li>
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#"> Product <span class="caret"></span>
					</a>
						<ul class="dropdown-menu" role="Product">
							<li>{{ link_to_route('product.index','List') }}</li>
							<li>{{ link_to_route('product.create','Add Product') }}</li>
						</ul></li>
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#"> Supplier <span class="caret"></span>
					</a>
						<ul class="dropdown-menu" role="Supplier">
							<li>{{ link_to_route('supplier.index','List') }}</li>
							<li>{{ link_to_route('supplier.create','Add Supplier') }}</li>
						</ul></li>
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#"> Location <span class="caret"></span>
					</a>
						<ul class="dropdown-menu" role="Location">
							<li>{{ link_to_route('location.index','List') }}</li>
							<li>{{ link_to_route('location.create','Add Location') }}</li>
						</ul></li>
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#"> Customer <span class="caret"></span>
					</a>
						<ul class="dropdown-menu" role="Customer">
							<li>{{ link_to_route('customer.index','List') }}</li>
							<li>{{ link_to_route('customer.create','Add Customer') }}</li>
						</ul></li>
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#"> Order <span class="caret"></span>
					</a>
						<ul class="dropdown-menu" role="Supplier">
							<li>{{ link_to_route('order.index','Purchase') }}</a></li>
							<li class="divider"></li>
							<li><a href="#">Sell</a></li>
						</ul></li>
